...
public interface IResponse {
    /**
     * @return {@link Status} based on the current state of the response
     */
    Status status();
    ...
    /**
     * @return the HTTP response code returned by the API if there was an error or
     * the exception message if any exceptions were thrown during fetch,
     * null if the status is "success" or "pending"
     */
    String error();
